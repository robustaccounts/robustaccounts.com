    ...
    <div ref={dropdownRef} className="relative w-full">
      ...
      >
        <div className="flex w-full flex-col">
          ...
          <div className="text-start w-full bg-transparent text-base font-medium outline-none">
      ...
      {isOpen && (
        <div className="text-start absolute top-full right-0 left-0 z-50 mt-1 max-h-60 overflow-auto rounded-xl border border-gray-200 bg-white shadow-lg">

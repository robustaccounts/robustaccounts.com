...
/**
 * Arrow icon used in CTA buttons throughout the site
 */
export const ArrowIcon = ({ className = "", size = 14 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
 ...
 */
export const ChevronDownIcon = ({ className = "", size = 12 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}

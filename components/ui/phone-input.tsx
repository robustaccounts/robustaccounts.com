...
export default function PhoneInput({
    ...
    return (
        <div ref={ref} className="relative w-full">
            ...
            >
                ...
                <div className="flex w-full flex-col">
                    ...
                    <input
                        ...
                        maxLength={
                            phoneValidationPatterns[countryCode]?.maxLength ||
                            15
                        }
                        value={value}
                        onChange={(e) =>
            ...
            {/* dropdown */}
            {open && !disabled && (
                <div className="absolute z-[9999] mt-1 max-h-60 w-full overflow-y-auto border-2 border-gray-200 bg-white shadow-xl">

...
const IntuitQuickbooks = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            viewBox="0 0 609.2 373.5"
            xmlSpace="preserve"
            {...props}
        >
            {/* Inline styles for SVG elements instead of <style> tag */}
            <path
                d="M565.6,213c0-1-1-1.4-1.9-1.4H562v5h0.9v-2h0.7l1.1,2h1.1l-1.3-2.2c0.6-0.1,1.1-0.7,1.1-1.3V213z M562.9,213.8v-1.4h0.8
        ...
        s10.1,5.8,10.1,11.3S461.5,210.5,454.6,210.5z"
                fill="#000"
            />
            <circle cx={86} cy={181} r={45} fill="#2CA01C" />
            <path
                d="M53.5,181c0,9.7,7.8,17.5,17.5,17.5h2.5V192H71c-6.1,0-11-4.9-11-11s4.9-11,11-11h6v34c0,3.6,2.9,6.5,6.5,6.5
        ...
        c0-3.6-2.9-6.5-6.5-6.5v47H101c9.7,0,17.5-7.8,17.5-17.5S110.7,163.5,101,163.5z"
            ...
            />
            <path
                d="M187,146.3c1.7,0,3-1.3,3-3c0-1.7-1.3-3-3-3s-3,1.3-3,3C184,145,185.3,146.3,187,146.3z M169.3,148.3c-2.5,0-4.9,1.4-6,3.7
...
export default IntuitQuickbooks;

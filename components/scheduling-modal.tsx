                ...
                <div className="flex h-full flex-col items-center justify-center p-4 sm:p-6 xl:mt-12">
                  ...
                  <div className="mb-8 flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-600 sm:text-base">
                      You're all set for your free consultation
                    </p>
                  </div>
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (selectedDate && selectedSlot) {
                            ...
                            const [hours, minutes] = selectedSlot.pstTime
                              .split(" ")[0]
                              .split(":")
                              .map(Number);
                  ...
                  <div className="w-full max-w-md space-y-4 text-center">
                    <div className="space-y-3 text-sm text-gray-600 sm:text-base">
                      <p className="font-medium">
                        We'll call you at the scheduled time to discuss your
                        accounting needs.
                      </p>
                      <p>
            ...
            >
              ...
              <div className="sticky top-0 z-10 flex w-full items-center justify-between border-b border-gray-200 bg-white px-4 py-4 sm:px-6 sm:py-6">
                ...
                <div className="px-2 text-center">
                  ...
                  {step === "contact" && selectedDate && selectedTimeSlot && (
                    ...
                    >
                      ...
                      <div className="space-y-4 sm:space-y-6">
                        <p className="text-sm leading-relaxed text-gray-600">
                          By clicking 'Confirm My Appointment' you agree to our{" "}
                          <Link
                          ...
                          . This includes permission to communicate with you
                          about your appointments via phone, email, or SMS.
                        </p>

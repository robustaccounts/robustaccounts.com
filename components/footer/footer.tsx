    ...
    <footer className="">
      <div className="flex flex-col gap-12 px-4 py-8 sm:px-6 md:grid md:grid-cols-5 lg:px-12">
        <div className="col-span-2 flex flex-col gap-4 lg:max-w-4/5">
          <span className="text-xl font-bold">robustaccounts.com</span>
          <p className="text-base font-medium">
            Transform your business with expert accounting outsourcing services.
        ...
        <div className="col-span-3 grid grid-cols-2 gap-x-4 gap-y-8 lg:grid-cols-4 lg:gap-x-12 lg:gap-y-16">
          ...
          {/* Company */}
          <div className="flex flex-col gap-4">
            <h4 className="text-lg font-semibold text-primary">About us</h4>
            <div className="flex flex-col gap-2">
              {about.map((about) => (
                <Link
                  key={about.title}
          ...
          {/* Policies */}
          <div className="flex flex-col gap-4">
            <h4 className="text-lg font-semibold text-primary">Policies</h4>
            <div className="flex flex-col gap-2">
              {policies.map((policy) => (
                <Link
                  key={policy.title}

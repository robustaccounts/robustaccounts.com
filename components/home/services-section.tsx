...
export default function ServicesSection() {
    return (
        <section
            className={cn(
                'container mx-auto flex h-full w-full flex-col items-center justify-center gap-12 px-4 py-16 sm:px-6 md:px-12 lg:px-16 lg:py-24 xl:min-h-screen xl:py-0',
            )}
        >

...
$$\$300,000 \text{ (Assets)} - \$180,000 \text{ (Liabilities)} = \$120,000 \text{ (Owner's Equity)}$$
...
1.  **Owner Capital Contributions:** This is money or other assets that you, the owner, invest *into* the business. Contributions directly **increase** owner's equity.
2.  **Owner Withdrawals (Draws):** This is cash or other assets you take *out* of the business for personal use. Withdrawals directly **decrease** owner's equity.
...
### Partnerships
Partnerships operate similarly but with added complexity. Instead of one capital account, there is an individual capital account for *each* partner. This account tracks each partner's respective stake, contributions, withdrawals, and share of profits or losses. A comprehensive partnership agreement is non-negotiable. It must clearly outline:
...
*This article is for informational purposes only and is not a substitute for professional legal, business, or tax advice. Please consult with your own attorney, business advisor, or tax advisor regarding your specific circumstances.*
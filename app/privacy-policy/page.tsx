            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  Robust Accounts ("we," "our," or "us") is committed to
              ...
              <section>
                ...
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
                  ...
                  <li>Financial information (for service provision)</li>
              ...
              <section>
                ...
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
                  <li>
                    Providing and maintaining our accounting and advisory
                    services
                  </li>
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  ...
                  your experience on our website. For detailed information about

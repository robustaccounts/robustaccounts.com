            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  These Terms of Service ("Terms") govern your use of the Robust
                  Accounts website and services. By accessing or using our
                ...
                <p className="mt-4 leading-relaxed text-gray-700">
                  Robust Accounts ("we," "us," or "our") provides accounting,
                  bookkeeping, financial advisory, and business advisory
              ...
              <section>
                ...
                <p className="mt-4 leading-relaxed text-gray-700">
                  All services are subject to separate service agreements and
                  engagement letters that will be provided to clients.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
                  ...
                  <li>
                    Use our services to transmit spam or unsolicited
                    communications
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
                  <li>
                    Fees are due upon receipt of invoice unless otherwise agreed
                    in writing
                  </li>
                  <li>
                    Late payments may result in additional charges and service
                    suspension
                  </li>
                  <li>
                  ...
                  <li>
                    We reserve the right to modify our pricing with appropriate
                    notice
                  </li>
                  <li>
                    Payment methods accepted will be specified in your service
                    agreement
                  </li>
                </ul>
                <p className="mt-4 leading-relaxed text-gray-700">
                  For detailed pricing information, please refer to our pricing
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  Our website and services contain intellectual property owned
                  by Robust Accounts, including:
                </p>
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  <strong>Service Disclaimer:</strong> Our services are provided
                  "as is" and "as available" without warranties of any kind,
                  either express or implied.
                </p>
                <p className="mb-4 leading-relaxed text-gray-700">
                  <strong>Financial Disclaimer:</strong> We provide accounting
                  and advisory services, but we do not guarantee specific
                  financial outcomes. Investment decisions should be made based
                  on your own research and consultation with qualified
                  professionals.
                </p>
                <p className="mb-4 leading-relaxed text-gray-700">
                  <strong>Limitation of Liability:</strong> To the maximum
                  extent permitted by law, Robust Accounts shall not be liable
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  You agree to indemnify and hold harmless Robust Accounts, its
                  officers, directors, employees, and agents from and against
                  any claims, damages, obligations, losses, liabilities, costs,
                  or debt arising from your use of our services or violation of
                  these Terms.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  ...
                  rules of [Arbitration Organization], unless otherwise required
                  by law.
                </p>
              </section>

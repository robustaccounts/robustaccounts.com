            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  This Cookie Policy explains how Robust Accounts ("we," "us,"
                  or "our") uses cookies and similar technologies when you visit
                  our website. This policy should be read alongside our{" "}
                  <Link
                    href="/privacy-policy"
                ...
                <p className="mt-4 leading-relaxed text-gray-700">
                  ...
                  cookies, you should set your browser settings accordingly or
              ...
              <section>
                ...
                <p className="leading-relaxed text-gray-700">
                  ...
                  delete them, while session cookies are deleted when you close
                  your browser.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  ...
                  help us know which pages are popular and least popular and see
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  ...
                  cookies. These services include:
                </p>
                <ul className="list-disc space-y-2 pl-6 leading-relaxed text-gray-700">
                  <li>
                  ...
                  <li>
                    <strong>Chat Services:</strong> For customer support and
                    communication
                  </li>
                </ul>
                <p className="mt-4 leading-relaxed text-gray-700">
                  These third-party services have their own privacy policies and
                  cookie policies. We encourage you to review their policies for
                  more information.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-4 leading-relaxed text-gray-700">
                  ...
                  consent banner. You can manage your cookie preferences through
                  this banner or by clicking the "Cookie Settings" link in our
                  footer.
                </p>
                ...
                <p className="leading-relaxed text-gray-700">
                  ...
                  marketing cookies, through industry opt-out tools such as:
                </p>
